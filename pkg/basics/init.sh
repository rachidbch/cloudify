...
pkg_depends apt-transport-https ca-certificates curl gnupg-agent software-properties-common bc 

# trash-cli is used by workify to safely delete files and directories 
pkg_depends trash-cli 

# Nice to have tooling 
pkg_depends tree procps jq rename pandoc moreutils silversearcher-ag 
