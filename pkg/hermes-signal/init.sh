...
msg ""
msg "Next steps — choose one:"
msg ""
msg "  Path A: Link your personal number (scan QR from phone):"
msg "    ${GATEWAY_DIR}/link-device.sh --phone +15551234567 --name mybot"
msg ""
msg "  Path B: Register a dedicated bot number (SMS verification):"
msg "    ${GATEWAY_DIR}/link-device.sh --register --phone +BOT_NUMBER"
msg ""
msg "  Then start the gateway:"
