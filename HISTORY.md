...
- Still open: the live policy lacks `tag:incus` in the ssh rule. A validated snapshot restore exists but is NOT applied (operator decision pending). Container SSH and the T1 e2e smoke remain blocked until it is.
